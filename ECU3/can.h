...
unsigned short can_transmit(unsigned int ID, unsigned int *data, unsigned int len);
unsigned char can_receive(unsigned int *msg_id,unsigned int *data,unsigned int *len);
